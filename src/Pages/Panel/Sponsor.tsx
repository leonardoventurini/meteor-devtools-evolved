   ...
   <div className={Classes.DRAWER_BODY}>
    ...
    <div className={Classes.DIALOG_BODY}>
     <div className="w-full mb-4 text-lg">
      ...
      <p>
       ✅ Do you want to scale your Meteor app confidently with minimal DevOps?
      </p>
      ...
      <p>
       If you answered yes to any of the questions above, we have the ultimate
       solution for you!
      </p>

      <p className="mb-4">
       Meteor Cloud provides a unique infrastructure designed for your Meteor
       app. Some of Meteor Cloud’s well-loved features include:
      </p>
